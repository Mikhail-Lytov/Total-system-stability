...
class FrameBeltWork(tk.Frame):
    ...
    def put_widgets(self):
        self.L_frame_belt_work_T = tk.Label(self,
                                            text='T_рем ' + str(self.level_repair_work_frame_beltwork) + '-уровня ' + str(
    ...
    def entr_frame_belt_work(self):
        ...
        self.L_frame_belt_work_T.configure(
            text='T_рем ' + str(self.level_repair_work_frame_beltwork) + '-уровня ' + str(self.index_repair_work_frame_beltwork) + ''
                                                                                                             '-го типа')
        self.master.refresh()
...
class Frame_b(tk.Frame):
    ...
    def put_widgets(self):
        self.L_B = tk.Label(self, text='B_РП ' + str(self.level_V_frame_B) + '-уровня ' + str(self.index_V_frame_B) + '-го типа')
    ...
    def entr_frame_B(self):
        ...
        self.L_B.configure(text='B ' + str(self.level_V_frame_B) + '-уровня ' + str(self.index_V_frame_B) + '-го типа')
        self.master.refresh()
